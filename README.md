...
[![Build Status](https://secure.travis-ci.org/FlorianWolters/PHP-Component-Util-Observer.png?branch=master)](http://travis-ci.org/FlorianWolters/PHP-Component-Util-Observer)

**FlorianWolters\Component\Util\Observer** provides the *Observer* behavioural design pattern as a simple-to-use [PHP][17] component.
...
**FlorianWolters\Component\Util\Observer** should be installed using the dependency manager [Composer][3]. [Composer][3] can be installed with [PHP][6].
...
**FlorianWolters\Component\Util\Observer** should be installed using the [PEAR installer][11]. This installer is the [PHP][17] community's de-facto standard for installing [PHP][17] components.
...
The best documentation for **FlorianWolters\Component\Util\Observer** are the unit tests, which are shipped in the package. You will find them installed into your [PEAR][10] repository, which on Linux systems is normally `/usr/share/php/test`.
...
[1]: http://blog.florianwolters.de/PHP-Component-Util-Observer
     "FlorianWolters\Component\Util\Observer | Application Programming Interface (API) documentation"
[2]: http://apigen.org
...
[20]: http://semver.org
      "Semantic Versioning"
[21]: http://packagist.org/packages/florianwolters/component-util-observer
      "florianwolters/component-util-observer - Packagist"
