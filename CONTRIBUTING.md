...
Contributions to **FlorianWolters\Component\Util\Observer** are always welcome.
...
Run the following commands to initially checkout **FlorianWolters\Component\Util\Observer**:

    md Observer && cd Observer
    git clone git://github.com/FlorianWolters/PHP-Component-Util-Observer.git
